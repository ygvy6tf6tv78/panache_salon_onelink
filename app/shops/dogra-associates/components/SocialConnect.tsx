  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #241C18 0%, #3B2A20 45%, #8B641E 100%)',
          boxShadow: '0 20px 40px rgba(36, 28, 24, 0.4), 0 0 0 1px rgba(248,231,163,0.18)',
        }}
      >
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="w-full h-11 rounded-2xl font-semibold text-[14px] text-slate-700 flex items-center justify-center gap-2 transition-all touch-manipulation relative overflow-hidden border-2 border-pink-500/70 bg-white/90"
            style={{
              boxShadow: '0 8px 16px rgba(0, 0, 0, 0.15), 0 4px 8px rgba(0, 0, 0, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.8)',
              WebkitTapHighlightColor: 'transparent',
            }}
          >
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-transparent via-pink-400/30 to-transparent animate-[shimmer_2s_infinite] pointer-events-none" />
            <Download className="w-4 h-4 relative z-10" style={{ color: '#7A2148' }} />

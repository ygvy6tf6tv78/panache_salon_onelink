...
const inputBase =
  'w-full min-w-0 bg-white rounded-xl px-4 py-3.5 text-[16px] text-slate-900 placeholder:text-slate-400 focus:outline-none transition-all duration-200 border-2 border-slate-200/90 focus:border-[#B32A64] focus:shadow-[0_0_0_3px_rgba(10,102,178,0.2)] shadow-[4px_4px_12px_rgba(15,42,68,0.08),-2px_-2px_8px_rgba(255,255,255,0.8)]'
...
Please confirm the appointment.`
  ...
  const handleSubmit = () => {
    ...
    const e164 = shopConfig.contact.clientPhoneE164 || '919149837277'
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(160deg, #F3C7D8 0%, #FFF1F6 42%, #B32A64 100%)',
        padding: 22,
        minHeight: '580px',
        boxSizing: 'border-box',
        boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.78), 0 4px 20px rgba(7,59,115,0.20)',
      }}
    >
      <div className="flex-1 overflow-y-auto">
        <h2 className="font-bold mb-1.5" style={{ fontSize: 22, color: '#7A2148' }}>
          Book Appointment
        </h2>
        ...
        <div className="space-y-3">
          <div>
            <label className="block text-[15px] font-semibold mb-1.5" style={{ color: '#7A2148' }}>Name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-[15px] font-semibold mb-1.5" style={{ color: '#B32A64' }}>Service</label>
          ...
          <div className="grid min-w-0 grid-cols-2 gap-2.5">
            <div className="min-w-0">
              <label className="block text-[13px] font-bold mb-1.5" style={{ color: '#7A2148' }}>Date</label>
              <button
                type="button"
            ...
            <div className="min-w-0">
              <label className="block text-[13px] font-bold mb-1.5" style={{ color: '#7A2148' }}>Time</label>
          ...
          <button
            ...
            disabled={!isValid}
            className="w-full rounded-xl py-3.5 font-semibold text-[16px] text-white border border-[#B32A64]/60 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-all touch-manipulation active:scale-[0.99] hover:brightness-[1.04]"
            style={{
              background: 'linear-gradient(135deg, #7A2148 0%, #B32A64 100%)',
              boxShadow: '0 6px 16px rgba(10, 102, 178, 0.4), inset 0 1px 0 rgba(255,255,255,0.2)',
          ...
          <button
            type="button"
            onClick={onBack}
            className="w-full rounded-xl py-3 font-semibold text-[15px] text-[#7A2148] border border-[#B32A64]/25 bg-white/35 hover:bg-white/55 backdrop-blur-sm transition-all touch-manipulation active:scale-[0.99] flex items-center justify-center gap-2"
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          background: isSelected ? '#7A2148' : 'transparent',

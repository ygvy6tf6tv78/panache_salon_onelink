...
export default function PaymentFace({
  ...
  return (
    <div
      ...
      style={{
        background:
          'radial-gradient(circle at 30% 30%, rgb(21, 124, 130) 0%, rgb(15, 118, 110) 42%, rgb(17, 19, 21) 100%)',
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center px-6 py-6 text-center" style={{ minHeight: '580px', paddingBottom: '2rem', pointerEvents: 'auto' }}>
        ...
        >
          ...
          >
            ...
            >
              <QrCode className="w-5 h-5" style={{ color: '#B32A64' }} />
      ...
      >
        <div className="flex items-center justify-center">
          ...
          >
            <Shield className="w-3.5 h-3.5" style={{ color: '#B32A64' }} />
            <span
        ...
        {scannerModalOpen && (
          ...
          >
            ...
            >
              ...
              >
                <Share2 className="w-4 h-4" style={{ color: '#B32A64' }} />

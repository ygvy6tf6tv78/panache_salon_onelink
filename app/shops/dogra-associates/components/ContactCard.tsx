...
const ICON_PILL_STYLE: React.CSSProperties = {
  ...
  border: '1px solid rgba(10, 102, 178, 0.55)',
  boxShadow: '0 2px 8px rgba(10, 102, 178, 0.32)',
}
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(145deg, #7A2148 0%, #B32A64 58%, #8A204F 100%)',
      ...
      >
        <div
          ...
          style={{
            background:
              'linear-gradient(145deg, #7A2148 0%, #B32A64 58%, #8A204F 100%)',
          }}
        >
          {/* Soft brand glow accents */}
          <div className="absolute right-0 top-0 h-28 w-28 rounded-full bg-[#B32A64]/22 blur-3xl" />
